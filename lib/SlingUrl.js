...
var SlingUrl = function SlingUrl(url) {
  _classCallCheck(this, SlingUrl);
  ...
  var firstDotPart = slashParts.filter(hasDot)[0]; // resource path

  this.resourcePath = pathnameHasDot ? pathname.substring(0, dotIndex) : pathname; // extension + selectors
  ...
  var suffix = dotPartIndex > -1 ? slashParts.slice(dotPartIndex + 1).join("/") : null;
